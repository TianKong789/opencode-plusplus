"""Asset domain models — reusable metadata for versioned, persistent artifacts.

Lives in core/models/ so that core/interfaces/ can depend on core domain
types without importing the assets layer.
"""
